...
fn test_send_friend_request() {
    ...
    let request_id = contract_dispatcher.send_friend_request(
        sender, receiver
    );

    let request = contract_dispatcher.get_friend_request(
        request_id, receiver
    );
...
fn test_accept_friend_request() {
    ...
    contract_dispatcher.accept_friend_request(
        request_id, receiver
    );
    ...
    assert(request.status == FriendRequestStatus::ACCEPTED.into(), 'Request status is not accepted');
}
...
fn test_reject_friend_request() {
    ...
    contract_dispatcher.reject_friend_request(
        request_id, receiver
    );
    ...
    assert(request.status == FriendRequestStatus::REJECTED.into(), 'Request status is not rejected');
}
...
fn test_delete_friend_request() {
    ...
    contract_dispatcher.delete_friend_request(
        request_id, receiver
    );
    // This should panic as the friend request no longer exists
    contract_dispatcher.get_friend_request(
        request_id, receiver
    );
}
